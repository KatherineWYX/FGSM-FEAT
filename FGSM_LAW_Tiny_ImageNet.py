...
def get_args():
    ...
    parser.add_argument('--lam_scale', default=0.08, type=float, help='Label Smoothing Scale')
    parser.add_argument('--lam_start', default=50, type=int, help='Label Smoothing time')
    # TDAT
    parser.add_argument('--gamma', default=0.025, type=float, help='Label relaxation factor')
    parser.add_argument('--inner_gamma', default=0.025, type=float, help='Label relaxation factor')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if epoch > args.lam_start:  # 50 轮以后才开始调整 lam_reg
            ...
            lam_reg = min(max(lam_reg, args.lamda), args.lamda * 1.4)
            print(lam_reg)
