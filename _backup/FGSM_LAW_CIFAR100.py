...
def get_args():
    ...
    parser.add_argument('--lam_scale', default=0.015, type=float, help='Label Smoothing Scale')
    ...
    parser.add_argument('--inner_gamma', default=0.05, type=float, help='Label relaxation factor')
...
def main():
    ...
    if args.lr_schedule == 'cyclic':
        ...
        scheduler = torch.optim.lr_scheduler.MultiStepLR(opt, milestones=[lr_steps * 94 / 110, lr_steps * 99 / 110],
                                                         gamma=0.1)
